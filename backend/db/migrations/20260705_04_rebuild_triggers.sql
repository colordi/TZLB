-- 阶段2迁移：重建触发器函数
-- sync_other_pest_event_from_inspection 需要更新表名引用：
--   sites.other_pest_sites → sites."其他害虫点位基础表"
--   v_site."乡镇" → v_site."属地"
--   ledger."2026年其他害虫问题点位事件流水表" → ledger."其他害虫问题点位事件流水表"
...
BEGIN
    ...
    INSERT INTO ledger."其他害虫问题点位事件流水表" (
        "事件时间",
        "事件类型",
        "虫害类型",
        "年份",
