...
import { getOtherPestSummary } from "../../api/statistics.js";
...
const { yearOptions, selectedYear } = useStatisticsYearOptions("other-pests");
...
async function loadSummary() {
  try {
    const result = await getOtherPestSummary({ year: selectedYear.value });
    summary.value = {
...
<template>
  <div class="flex flex-col gap-4">
    <StatisticsYearFilter
      ...
      testid="data-statistics-other-pest-year-filter"
    />

    <Card data-testid="data-statistics-other-pest-totals">
      ...
      <CardContent>
        <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <div class="rounded-lg border p-4" data-testid="data-statistics-other-pest-kpi-survey">
          ...
          <div class="rounded-lg border p-4" data-testid="data-statistics-other-pest-kpi-problem">
          ...
          <div class="rounded-lg border p-4" data-testid="data-statistics-other-pest-kpi-rate">
          ...
          <div class="rounded-lg border p-4" data-testid="data-statistics-other-pest-kpi-ledger">
    ...
    <Card data-testid="data-statistics-other-pest-types">
      <CardHeader class="pb-3">
        ...
        <Table v-if="summary.pest_types.length">
          ...
          <TableBody>
            <TableRow
              ...
              :key="item.pest_type"
              :data-testid="`data-statistics-other-pest-row-${item.pest_type}`"
            >
